/* OMP version of the 4-point jacobi stencil to solve the Laplace equation.
 * Compile it with `gcc -o laplace.omp 3_omp.c image_ppm.c -lm -O1 -fopenmp`.
 * Run it with `OMP_NUM_THREADS=4 ./laplace.omp -i example_input.ppm`
 */
